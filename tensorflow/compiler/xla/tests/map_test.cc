...
public:
	...
	Computation CreateAdderToOne()
	{
		...
		auto x = mapped_builder.Parameter(0, ShapeUtil::MakeShape(F32, { }),
				"x");
  ...
  // y {R0F32} ----> (add) ---> (add)
	...
	Computation CreateTernaryAdder()
	{
		...
		auto x = mapped_builder.Parameter(0, ShapeUtil::MakeShape(F32, { }),
				"x");
		auto y = mapped_builder.Parameter(1, ShapeUtil::MakeShape(F32, { }),
				"y");
		auto z = mapped_builder.Parameter(2, ShapeUtil::MakeShape(F32, { }),
				"z");
