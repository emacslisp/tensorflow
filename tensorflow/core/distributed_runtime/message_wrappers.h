...
public:
	...
	virtual Status AddTensorFromRunGraphResponse(const string& name,
...
public:
	...
	Status AddTensorFromRunGraphResponse(const string& name,
			MutableRunGraphResponseWrapper* run_graph_response, size_t i)
					override;
