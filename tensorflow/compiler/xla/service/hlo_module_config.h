...
public:
	...
	{
		return hlo_profiling_enabled_;
	}
	void enable_hlo_profiling(bool enabled)
	{
		hlo_profiling_enabled_ = enabled;
	}
	...
	bool fast_math_disabled() const
	{
		return fast_math_disabled_;
	}
	void set_fast_math_disabled(bool disabled)
	{
		fast_math_disabled_ = disabled;
	}
