...
static std::vector<int64> GeneratePoolingSequencePseudoRandom(int input_length,
		int output_length, GuardedPhiloxRandom* generator)
{
...
static std::vector<int64> GeneratePoolingSequenceRandom(int input_length,
		int output_length, GuardedPhiloxRandom* generator)
{
	int k = input_length / output_length;
...
std::vector<int64> GeneratePoolingSequence(int input_length, int output_length,
		GuardedPhiloxRandom* generator, bool pseudo_random)
{
	...
	if (pseudo_random) {
		...
		diff = GeneratePoolingSequenceRandom(input_length, output_length,
				generator);
	}
