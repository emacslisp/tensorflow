...
static void AllocateFlags()
{
	...
	flag_list =
			new std::vector<Flag>(
					{
							Flag("parallel_check_failfast",
									&flags->parallel_check_failfast,
									"Fail immediately on first parallel-check comparison error."),
							Flag("parallel_check_atol",
									&flags->parallel_check_atol,
									"Absolute error tolerance for parallel-check comparison."),
							Flag("parallel_check_rtol",
									&flags->parallel_check_rtol,
