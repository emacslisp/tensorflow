...
protected:
	...
	{
		se::Platform* platform = se::MultiPlatformManager::PlatformWithId(
				se::host::kHostPlatformId).ValueOrDie();
		stream_exec_ = platform->GetExecutor(
				se::StreamExecutorConfig(/*ordinal=*/0)).ValueOrDie();
	}
