...
public:
	HloToIrBindings(const HloModule& module,
			...
			buffer_assignment_(buffer_assignment), temp_buffer_offsets_(
					temp_buffer_offsets), is_nested_(is_nested), ir_builder_(
					ir_builder), alias_analysis_(module, *buffer_assignment_,
