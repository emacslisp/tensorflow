...
public:
	...
	{
		std::vector<const LayoutConstraint*> ret_vec(
				std::move(added_constraints_));
...
private:
	...
	std::unordered_map<const LogicalBuffer*, BufferLayoutConstraint> buffer_constraints_;
