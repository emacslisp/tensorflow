...
static void AllocateFlags()
{
	...
	flag_list =
			new std::vector<tensorflow::Flag>(
					{
							tensorflow::Flag("xla_hlo_profile",
									&flags->xla_hlo_profile,
									"Instrument the computation to collect per-HLO cycle counts"),
							tensorflow::Flag("xla_log_hlo_text",
									&flags->xla_log_hlo_text,
							...
							tensorflow::Flag("xla_generate_hlo_graph",
									&flags->xla_generate_hlo_graph,
							...
							tensorflow::Flag("xla_hlo_graph_layout",
									&flags->xla_hlo_graph_layout,
							...
							tensorflow::Flag("xla_dump_computations_to",
									...
									"Dumps computations that XLA executes into the provided "
											"directory path"),
							tensorflow::Flag("xla_dump_hlo_text_to",
									&flags->xla_dump_hlo_text_to,
