...
public:
	explicit XlaBinaryOp(OpKernelConstruction* ctx) :
			XlaOpKernel(ctx)
	{
	...
	virtual xla::ComputationDataHandle Computation(XlaOpKernelContext* ctx,
...
public:
	explicit XlaBinaryMapOp(OpKernelConstruction* ctx) :
			XlaBinaryOp(ctx)
	{
	}
	...
	xla::ComputationDataHandle Computation(XlaOpKernelContext* ctx,
			const xla::ComputationDataHandle& lhs,
			const gtl::ArraySlice<int64>& lhs_shape,
			const xla::ComputationDataHandle& rhs,
			const gtl::ArraySlice<int64>& rhs_shape,
