...
public:
	explicit TileOp(OpKernelConstruction* ctx) :
			XlaOpKernel(ctx)
	{
	}
	...
	void Compile(XlaOpKernelContext* ctx) override
	{
		...
		OP_REQUIRES(ctx, IsLegacyVector(multiples_shape),
		...
		xla::ComputationDataHandle output = ctx->builder()->Reshape(broadcasted,
