...
private:
	...
	::tensorflow::Status GetOrCreateExecutors(thread::ThreadPool* pool,
	...
	string session_handle_;bool graph_created_ GUARDED_BY(graph_def_lock_) = false;

	mutex graph_def_lock_;GraphDef
	graph_def_ GUARDED_BY(graph_def_lock_);
	...
	mutex closed_lock_;bool closed_ GUARDED_BY(closed_lock_) = false;
