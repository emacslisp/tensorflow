...
public:
			...
			tensorflow::gtl::ArraySlice<int64> window_strides, Padding padding)
	{
		builder_.ReduceWindow(input, builder_.ConstantR0<float>(0.0f),
				CreateScalarAddComputation(F32, &builder_), window_dimensions,
			...
			tensorflow::gtl::ArraySlice<int64> window_strides, Padding padding)
	{
		builder_.ReduceWindow(input,
				builder_.ConstantLiteral(LiteralUtil::MinValue(F32)),
			...
			tensorflow::gtl::ArraySlice<int64> window_strides, Padding padding)
	{
		builder_.ReduceWindow(input,
				...
				CreateScalarMinComputation(F32, &builder_), window_dimensions,
				window_strides, padding);
	}
