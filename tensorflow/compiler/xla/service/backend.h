...
public:
	...
	const std::vector<perftools::gputools::StreamExecutor*>& stream_executors() const
	{
	...
	{
		return tensorflow::strings::StrCat(platform_->Name(), ":",
				device_ordinal);
	}
	...
	StatusOr<bool> devices_equivalent(int device_ordinal_a,
