...
public:
	...
	template<typename NativeT>
	ComputationDataHandle ConstantR1(
	...
	ComputationDataHandle DynamicSlice(const ComputationDataHandle& operand,
	...
	ComputationDataHandle GetTupleElement(
	...
	static StatusOr<ConvolutionDimensionNumbers> CreateConvDimensionNumbers(
			int64 batch, int64 feature, int64 first_spatial,
			int64 second_spatial, int64 kernel_output_feature,
			int64 kernel_input_feature, int64 kernel_first_spatial,
			int64 kernel_second_spatial);
	...
	ComputationDataHandle ConvGeneral(const ComputationDataHandle& lhs,
			const ComputationDataHandle& rhs,
			tensorflow::gtl::ArraySlice<int64> window_strides,
			tensorflow::gtl::ArraySlice<std::pair<int64, int64>> padding,
			const ConvolutionDimensionNumbers& dimension_numbers);
	...
	ComputationDataHandle ConvGeneralDilated(const ComputationDataHandle& lhs,
			const ComputationDataHandle& rhs,
			tensorflow::gtl::ArraySlice<int64> window_strides,
			tensorflow::gtl::ArraySlice<std::pair<int64, int64>> padding,
	...
	ComputationDataHandle Call(const Computation& computation,
			tensorflow::gtl::ArraySlice<ComputationDataHandle> operands);
	...
	ComputationDataHandle CustomCall(const string& call_target_name,
			tensorflow::gtl::ArraySlice<ComputationDataHandle> operands,
			const Shape& shape);
	...
	ComputationDataHandle LogicalAnd(const ComputationDataHandle& lhs,
			const ComputationDataHandle& rhs,
			tensorflow::gtl::ArraySlice<int64> broadcast_dimensions = { });

	ComputationDataHandle LogicalOr(const ComputationDataHandle& lhs,
			const ComputationDataHandle& rhs,
			tensorflow::gtl::ArraySlice<int64> broadcast_dimensions = { });
	...
	ComputationDataHandle SelectAndScatter(const ComputationDataHandle& operand,
	...
	ComputationDataHandle ConvertElementType(
			const ComputationDataHandle& operand,
	...
	ComputationDataHandle Transpose(const ComputationDataHandle& operand,
	...
	ComputationDataHandle RngNormal(const ComputationDataHandle& mu,
			const ComputationDataHandle& sigma, const Shape& shape);
	...
	ComputationDataHandle RngUniform(const ComputationDataHandle& a,
			const ComputationDataHandle& b, const Shape& shape);
	...
	void Send(const ComputationDataHandle& operand,
	...
	StatusOr<std::unique_ptr<GlobalData>> ComputeConstant(
			const ComputationDataHandle& handle, const Layout* output_layout =
					nullptr);
...
private:
	...
	ComputationDataHandle BinaryOp(BinaryOperation binop,
			const ComputationDataHandle& lhs, const ComputationDataHandle& rhs,
			tensorflow::gtl::ArraySlice<int64> broadcast_dimensions);
	...
	ComputationDataHandle RngOp(RandomDistribution distribution,
