...
public:
	...
	{
		return has_constant_value_;
	}
	const Tensor& constant_value() const
	{
...
public:
	...
	const std::vector<XlaCompiler::Argument>& args() const
	{
		return args_;
	}
	xla::ComputationDataHandle parameter(int num)
	{
	...
	bool allow_cpu_custom_calls() const
	{
		return allow_cpu_custom_calls_;
	}
...
private:
	...
	bool has_context_parameter_ GUARDED_BY(mu_) = false;xla::ComputationDataHandle context_parameter_ GUARDED_BY(mu_);
