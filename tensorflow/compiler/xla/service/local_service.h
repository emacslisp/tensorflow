...
public:
	...
	StatusOr<GlobalDataHandle> AllocateBufferOnDevice(const Shape& shape,
			int device_ordinal, bool allocate_space_for_deep_copy);
	...
	//  second.
	tensorflow::Status ExecuteLocally(const ComputationHandle& computation,
			tensorflow::gtl::ArraySlice<const ShapedBuffer*> arguments,
