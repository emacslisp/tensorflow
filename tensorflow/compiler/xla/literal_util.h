...
template<typename NativeT>
/* static */std::unique_ptr<Literal> LiteralUtil::CreateR2FromArray2DWithLayout(
		const Array2D<NativeT>& values, const Layout& layout)
{
	auto literal = MakeUnique<Literal>();
...
template<typename NativeT>
/* static */std::unique_ptr<Literal> LiteralUtil::CreateR3FromArray3DWithLayout(
		const Array3D<NativeT>& values, const Layout& layout)
{
	auto literal = MakeUnique<Literal>();
...
template<typename NativeT>
/* static */std::unique_ptr<Literal> LiteralUtil::CreateR4FromArray4DWithLayout(
		const Array4D<NativeT>& values, const Layout& layout)
{
	auto literal = MakeUnique<Literal>();
...
template<typename NativeT>
/* static */NativeT LiteralUtil::Get(const Literal& literal,
		tensorflow::gtl::ArraySlice<int64> multi_index)
{
...
template<>
/* static */inline uint8 LiteralUtil::Get<uint8>(const Literal& literal,
		tensorflow::gtl::ArraySlice<int64> multi_index)
{
...
template<>
/* static */inline int8 LiteralUtil::Get<int8>(const Literal& literal,
		tensorflow::gtl::ArraySlice<int64> multi_index)
{
...
template<typename NativeT>
/* static */void LiteralUtil::Set(Literal* literal,
...
template<>
/* static */inline void LiteralUtil::Set(Literal* literal,
		tensorflow::gtl::ArraySlice<int64> multi_index, uint8 value)
{
	int64 linear_index = LinearIndex(*literal, multi_index);
...
template<>
/* static */inline void LiteralUtil::Set(Literal* literal,
		tensorflow::gtl::ArraySlice<int64> multi_index, int8 value)
{
...
template<typename NativeT>
/* static */void LiteralUtil::EachCell(const Literal& literal,
		std::function<
				void(tensorflow::gtl::ArraySlice<int64> indices, NativeT value)> per_cell)
{
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShape(
			primitive_util::NativeToPrimitiveType<uint8>(), { });
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShape(
			primitive_util::NativeToPrimitiveType<int8>(), { });
	literal->mutable_u8s()->push_back(value);
}
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShape(
			primitive_util::NativeToPrimitiveType<uint64>(), { });
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShape(
			primitive_util::NativeToPrimitiveType<int64>(), { });
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShape(PRED, {
			static_cast<int64>(values.bits()) });
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShapeWithLayout(
			primitive_util::NativeToPrimitiveType<NativeT>(), { values.height(),
					values.width() }, AsInt64Slice(layout.minor_to_major()));
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShapeWithLayout(
			primitive_util::NativeToPrimitiveType<NativeT>(), { values.n1(),
					values.n2(), values.n3() },
			AsInt64Slice(layout.minor_to_major()));
...
{
	*literal->mutable_shape() = ShapeUtil::MakeShapeWithLayout(
			primitive_util::NativeToPrimitiveType<NativeT>(), { values.planes(),
					values.depth(), values.height(), values.width() },
			AsInt64Slice(layout.minor_to_major()));
...
template<typename NativeT>
/* static */void LiteralUtil::PopulateWithValue(NativeT value,
		...
		const Literal& literal)
{
	...
	*result_literal->mutable_shape() = result_shape;
	LiteralUtil::Reserve(ShapeUtil::ElementsIn(result_shape),
			result_literal.get());
	LiteralUtil::EachCell<NativeSrcT>(literal,
...
template<typename NativeT>
/* static */std::unique_ptr<Literal> LiteralUtil::CreateFullWithMonotonicDim0MajorLayout(
		tensorflow::gtl::ArraySlice<int64> dimensions, NativeT value)
{
