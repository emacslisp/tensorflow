...
public:
	...
	inline static int cmp(const TTypes<int64>::ConstMatrix& a_idx,
			const TTypes<int64>::ConstMatrix& b_idx, const int64 a_row,
			const int64 b_row, const int dims)
	{
...
public:
	FixedDimComparator(const TTypes<int64>::Matrix& ix,
			const VarDimArray& order, const TensorShape& shape) :
