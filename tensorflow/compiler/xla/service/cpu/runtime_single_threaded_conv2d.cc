...
TF_ATTRIBUTE_NO_SANITIZE_MEMORY void __xla_cpu_runtime_EigenSingleThreadedConvF32(
		...
		int64 input_batch, int64 input_rows, int64 input_cols,
...
{
	tensorflow::xla::EigenConvF32Impl(Eigen::DefaultDevice(), out, lhs, rhs,
			input_batch, input_rows, input_cols, input_channels, kernel_rows,
			kernel_cols, kernel_channels, kernel_filters, output_rows,
			output_cols, row_stride, col_stride, padding_top, padding_bottom,
