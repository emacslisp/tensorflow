...
public:
	explicit ForLoopNest(llvm::IRBuilder<>* ir_builder) :
			outer_loop_preheader_bb_(nullptr), outer_loop_exit_bb_(nullptr), inner_loop_body_bb_(
					nullptr), ir_builder_(ir_builder)
	{
	}
	...
	IrArray::Index AddLoopsForShapeOnDimensions(const Shape& shape,
