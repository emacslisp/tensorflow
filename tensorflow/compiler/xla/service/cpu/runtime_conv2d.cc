		...
		int64 rhs_row_dilation, int64 rhs_col_dilation)
{
	...
	tensorflow::xla::EigenConvF32Impl(*run_options->intra_op_thread_pool(), out,
			lhs, rhs, input_batch, input_rows, input_cols, input_channels,
			...
			lhs_col_dilation, rhs_row_dilation, rhs_col_dilation);
}
