...
public:
	explicit ParallelConcatUpdate(OpKernelConstruction* ctx) :
			OpKernel(ctx)
	{
	...
	void Compute(OpKernelContext* ctx) override
	{
		...
		OP_REQUIRES_OK(ctx,
				::tensorflow::functor::DoParallelConcat(d, update, loc_,
						&output));
...
public:
	explicit ParallelConcatStart(OpKernelConstruction* ctx) :
			OpKernel(ctx)
	{
...
public:
	explicit FailureKernel(OpKernelConstruction* ctx) :
			OpKernel(ctx)
	{
		OP_REQUIRES_OK(ctx,
