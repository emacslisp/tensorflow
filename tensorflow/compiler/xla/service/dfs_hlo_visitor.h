...
public:
	...
	virtual Status HandleSelect(HloInstruction* select, HloInstruction* pred,
			HloInstruction* on_true, HloInstruction* on_false) = 0;
	...
	virtual Status HandleConcatenate(HloInstruction* concatenate,
	...
	virtual Status HandleConvolution(HloInstruction* convolution,
			HloInstruction* lhs, HloInstruction* rhs, const Window& window) = 0;
	...
	virtual Status HandleRemainder(HloInstruction* remainder,
			HloInstruction* lhs, HloInstruction* rhs)
	{
		return HandleElementwiseBinary(remainder, HloOpcode::kRemainder, lhs,
				rhs);
	}
	...
	virtual Status HandleLogicalOr(HloInstruction* logical_or,
			HloInstruction* lhs, HloInstruction* rhs)
	{
		return HandleElementwiseBinary(logical_or, HloOpcode::kLogicalOr, lhs,
				rhs);
	}
	...
	virtual Status HandleSort(HloInstruction* sort,
			HloInstruction* operand) = 0;
	...
	virtual Status HandleCall(HloInstruction* call,
			tensorflow::gtl::ArraySlice<HloInstruction*> operands,
			HloComputation* computation) = 0;
	virtual Status HandleCustomCall(HloInstruction* custom_call,
			tensorflow::gtl::ArraySlice<HloInstruction*> operands,
			tensorflow::StringPiece custom_call_target) = 0;
	virtual Status HandleSlice(HloInstruction* slice,
			HloInstruction* operand) = 0;
	virtual Status HandleDynamicSlice(HloInstruction* slice,
			tensorflow::gtl::ArraySlice<HloInstruction*> operands) = 0;
	virtual Status HandleDynamicUpdateSlice(
			HloInstruction* dynamic_update_slice, HloInstruction* operand,
			HloInstruction* update, HloInstruction* start_indices) = 0;
	virtual Status HandleTuple(HloInstruction* tuple,
			tensorflow::gtl::ArraySlice<HloInstruction*> operands) = 0;
	virtual Status HandleMap(HloInstruction* map,
			tensorflow::gtl::ArraySlice<HloInstruction*> operands,
	...
	virtual Status HandleWhile(HloInstruction* xla_while, HloInstruction* init,
			HloComputation* condition, HloComputation* body) = 0;
	...
	enum VisitState {
		kNotVisited, kVisiting, kVisited,
	};
