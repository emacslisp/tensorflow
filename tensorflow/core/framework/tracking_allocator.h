...
private:
	...
	struct Chunk {
		...
		int64 allocation_id;
	};std::unordered_map<void*, Chunk> in_use_ GUARDED_BY(mu_);int64
	next_allocation_id_ GUARDED_BY(mu_);
};
