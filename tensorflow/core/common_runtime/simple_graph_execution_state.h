...
public:
	...
	// calling this method.
	static Status MakeForBaseGraph(GraphDef* graph_def,
	...
	// `subgraph_options`.
	static Status MakeForPrunedGraph(const FunctionDefLibrary& func_def_lib,
			const SimpleGraphExecutionStateOptions& options,
...
private:
	...
	mutable mutex mu_;CostModel
	costs_ GUARDED_BY(mu_);
