...
// can be added as needed.
	...
	denormals_zero_mode_ = _MM_GET_DENORMALS_ZERO_MODE()
...
ScopedFlushDenormal::~ScopedFlushDenormal()
{
	...
	_MM_SET_FLUSH_ZERO_MODE(
			flush_zero_mode_ ? _MM_FLUSH_ZERO_ON : _MM_FLUSH_ZERO_OFF);
	_MM_SET_DENORMALS_ZERO_MODE(
			denormals_zero_mode_ ? _MM_DENORMALS_ZERO_ON : _MM_DENORMALS_ZERO_OFF);
#endif
}
