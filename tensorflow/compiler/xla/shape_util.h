...
public:
	ShapeIndex() = default;
	ShapeIndex(std::initializer_list<int64> init) :
			indices_(init)
	{
	}
	...
	std::vector<int64>::const_iterator begin() const
	{
		return indices_.begin();
	}
	std::vector<int64>::const_iterator end() const
	{
		return indices_.end();
	}
	std::vector<int64>::iterator begin()
	{
		return indices_.begin();
	}
	std::vector<int64>::iterator end()
	{
		return indices_.end();
	}
...
public:
	...
	static ProgramShape MakeProgramShape(
	...
	static const Shape& GetSubshape(const Shape& shape,
	...
	static Shape PermuteDimensions(
