...
protected:
	void TestSimpleTree()
	{
		...
		GraphDef result;
		TF_ASSERT_OK(ObsfucateNames(graph_def, { { "const_node1" }, {
				"add_node1" } }, &result));
	...
	void TestManyNodes()
	{
		...
		GraphDef result;
		TF_ASSERT_OK(ObsfucateNames(graph_def, { { "const_node0" }, {
				"const_node999" } }, &result));
	...
	void TestNameClashes()
	{
		...
		GraphDef result;
		TF_ASSERT_OK(
				ObsfucateNames(graph_def, { { "10" }, { "19" } }, &result));
