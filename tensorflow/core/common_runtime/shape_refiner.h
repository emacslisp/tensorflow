...
private:
	...
	Status ExtractConstantSubgraph(Node* node, Graph* out_graph,
	...
	//
	// Owns values.
	std::unordered_map<const Node*, shape_inference::InferenceContext*> node_to_context_;
