...
public:
	...
	public:
		...
		Index SourceIndexOfReshape(const Shape& shape,
		...
		Index SourceIndexOfTranspose(const Shape& shape,
	...
	IrArray() :
			base_ptr_(nullptr), shape_(nullptr)
	{
	}
