...
public:
	...
	Status HandleConvert(HloInstruction* convert, HloInstruction* /*operand*/) override
	{
	...
	Status HandleReverse(HloInstruction* reverse, HloInstruction* /*operand*/) override
	{
