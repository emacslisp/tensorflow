...
public:
	...
	// 3.5".
	const string &platform_version() const
	{
	...
	// dependent format.
	const string &driver_version() const
	{
	...
	const string &runtime_version() const
	{
	...
	// on a multiprocessor.
	const uint64 blocks_per_core_limit() const
	{
		return blocks_per_core_limit_;
	}
	...
	const uint64 &threads_per_warp() const
	{
	...
	const string &device_vendor() const
	{
