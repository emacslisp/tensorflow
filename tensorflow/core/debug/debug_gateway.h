...
public:
	...
	typedef std::function<void(const string& node_name, const bool any_output)> NodeCompletionCallback;
	...
	typedef std::function<
			void(const string& node_name, const int output_slot,
					const Tensor& tensor_value, const bool is_ref)> NodeValueCallback;
