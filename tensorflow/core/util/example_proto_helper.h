...
Status SingleExampleProtoToTensors(const Example& example, const string& name,
...
public:
	...
	Status Init(ContextType* ctx)
	{
		...
		TF_RETURN_IF_ERROR(
				ctx->GetAttr("Ncontext_sparse", &num_context_sparse));
		TF_RETURN_IF_ERROR(
				ctx->GetAttr("Tcontext_dense", &context_dense_types));
		TF_RETURN_IF_ERROR(
				ctx->GetAttr("feature_list_sparse_types",
						&feature_list_sparse_types));
		TF_RETURN_IF_ERROR(
				ctx->GetAttr("feature_list_dense_types",
		...
		TF_RETURN_IF_ERROR(
				ctx->GetAttr("feature_list_dense_shapes",
