...
bool PotentiallyImplementedAsEigenConvolution(const HloInstruction& convolution)
{
	...
	bool input_spatial_dims_ascending = dnums.spatial_dimensions(0)
			< dnums.spatial_dimensions(1);
	bool kernel_spatial_dims_ascending = dnums.kernel_spatial_dimensions(0)
		...
		const Shape& output_shape)
{
	...
	return output_shape.element_type() == F32 && IsRank2WithNoPadding(lhs_shape)
