...
static const char kExampleParseConfigurationProto[] =
		R"( feature_map {
  key: "x"
  value {
    fixed_len_feature {
...
class ExampleParserConfigurationProtoToFeatureVectorsTest: public ::testing::Test {
protected:
	void SetUp() override
	{
		CHECK(
				protobuf::TextFormat::ParseFromString(
						kExampleParseConfigurationProto, &config_proto_));
	}
