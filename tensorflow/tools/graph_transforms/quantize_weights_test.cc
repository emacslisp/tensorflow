...
protected:
	void TestQuantizeWeights()
	{
		...
		test::FillValues<float>(&weights_data, { 1.0f, 2.0f, 3.0f, 4.0f, 0.1f,
				0.2f, 0.3f, 0.4f, 1.0f, 2.0f, 3.0f, 4.0f, 0.1f, 0.2f, 0.3f,
				0.4f, 1.0f, 2.0f, 3.0f, 4.0f, 0.1f, 0.2f, 0.3f, 0.4f, 1.0f,
				2.0f, 3.0f, 4.0f, 0.1f, 0.2f, 0.3f, 0.4f, 1.0f, 2.0f, 3.0f,
		...
		const string& weights_const_name = NodeNameFromInput(
				q_weights_op->input(0));
