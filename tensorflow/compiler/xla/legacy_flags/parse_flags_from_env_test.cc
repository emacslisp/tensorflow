...
static void TestParseFlagsFromEnv(const char* msg)
{
	...
	std::vector<tensorflow::Flag> flag_list = { tensorflow::Flag("simple",
			&simple, ""), tensorflow::Flag("with_value", &with_value, ""),
...
static const char kTestFlagString[] = "--simple "
		"--with_value=a_value "
...
const std::vector<tensorflow::Flag> flag_list =
		{ tensorflow::Flag("recursing", &recursing,
				...
				tensorflow::Flag("int_flag", &int_flag,
						"An integer flag to test with"), };
