...
static void BuildRunGraphRequest(const RunStepRequestWrapper& run_step_request,
...
static void CheckRunStepResponse(const MutableRunStepResponseWrapper& response)
{
