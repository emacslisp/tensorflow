...
public:
	explicit SparseAddGradOp(OpKernelConstruction *ctx) :
			OpKernel(ctx)
	{
	}
	...
	void Compute(OpKernelContext *ctx) override
	{
		...
		OP_REQUIRES_OK(ctx,
				ctx->input("backprop_val_grad", &backprop_val_grad));
		...
		OP_REQUIRES(ctx, TensorShapeUtils::IsVector(backprop_val_grad->shape()),
				errors::InvalidArgument(
		...
		OP_REQUIRES(ctx,
				...
				errors::InvalidArgument(
						"The densified operands should have the same "
