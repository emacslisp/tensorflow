...
{
	string key = tensorflow::strings::StrCat("profiling=",
			hlo_profiling_enabled_, "::hybrid=", has_hybrid_result_);
	StrAppend(&key, "::(");
	std::vector<string> params;
	for (const ShapeLayout& param_layout : entry_computation_layout_.parameter_layouts()) {
