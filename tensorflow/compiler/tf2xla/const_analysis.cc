		...
		std::vector<bool>* compile_time_const_args)
{
	...
	const std::unordered_multimap<string, string> compile_time_const_inputs = {
			{ "All", "reduction_indices" }, { "Any", "reduction_indices" }, {
					"ArgMax", "dimension" },
			{ "AvgPoolGrad", "orig_input_shape" }, { "BroadcastGradientArgs",
					"s0" }, { "BroadcastGradientArgs", "s1" }, { "Concat",
					"concat_dim" }, { "ConcatV2", "axis" }, { "ConcatOffset",
					"concat_dim" }, { "ConcatOffset", "shape" }, {
					"Conv2DBackpropFilter", "filter_sizes" }, {
					"Conv2DBackpropInput", "input_sizes" }, { "DynamicStitch",
					"indices" }, { "ExpandDims", "dim" }, { "Fill", "dims" }, {
					"InvertPermutation", "x" }, { "LinSpace", "start" }, {
					"LinSpace", "stop" }, { "LinSpace", "num" }, { "Max",
					"reduction_indices" }, { "Mean", "reduction_indices" }, {
					"Min", "reduction_indices" }, { "Pad", "paddings" }, {
					"Prod", "reduction_indices" }, { "RandomStandardNormal",
					"shape" }, { "RandomUniform", "shape" }, {
					"RandomUniformInt", "shape" }, { "Range", "start" }, {
					"Range", "limit" }, { "Range", "delta" }, { "Reshape",
					"shape" }, { "Slice", "begin" }, { "Slice", "size" }, {
					"Split", "split_dim" }, { "SplitV", "split_dim" }, {
					"SplitV", "size_splits" }, { "StridedSlice", "begin" }, {
					"StridedSlice", "end" }, { "StridedSlice", "strides" }, {
					"StridedSliceGrad", "shape" },
			{ "StridedSliceGrad", "begin" }, { "StridedSliceGrad", "end" }, {
					"StridedSliceGrad", "strides" }, { "Sum",
					"reduction_indices" }, { "Tile", "multiples" }, {
					"Transpose", "perm" } };

	// Operators that don't look at the data of their inputs, just the shapes.
	const std::unordered_set<string> metadata_ops = { "Rank", "Shape", "ShapeN",
			"Size", };
