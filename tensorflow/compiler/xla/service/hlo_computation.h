...
public:
	...
	public:
		...
		// root.
		std::unique_ptr<HloComputation> Build(HloInstruction* root_instruction =
				nullptr);
	...
	Status ReplaceWithNewInstruction(HloInstruction* old_instruction,
...
private:
	explicit HloComputation(const string& name, int parameter_count,
	...
	std::unordered_map<const HloInstruction*, InstructionList::iterator> instruction_iterators_;
