...
protected:
	...
	DeviceMemory(void *opaque, uint64 size) :
			DeviceMemoryBase(opaque, size)
	{
	}
};
...
public:
	...
	ScopedDeviceMemory(ScopedDeviceMemory &&other) noexcept:ScopedDeviceMemory(other.parent_, other.Release()) {}
