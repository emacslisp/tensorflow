...
typedef std::unordered_map<StringPiece, int32, StringPiece::Hasher> NodeNameToCostIdMap;
...
public:
	...
	explicit CostModel(bool is_global) :
	...
	void RecordMaxMemorySize(const Node* node, int output_slot, Bytes bytes,
			const TensorShapeProto& tensor_shape, const DataType& dtype);
