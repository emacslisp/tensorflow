...
public:
	...
	AllocateBytes(perftools::gputools::Stream* stream, int64 byte_size)
			override;
...
public:
	...
	ConvolutionThunk(ConvolutionKind convolution_kind,
			...
			BufferAllocation::Index output_buffer, const Shape& input_shape,
...
private:
	tensorflow::Status ConvolveWithTune(
			...
			const perftools::gputools::dnn::ConvolutionDescriptor& convolution_descriptor,
			const BufferAllocations& buffer_allocations,
