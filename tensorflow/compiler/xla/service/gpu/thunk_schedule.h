...
public:
	...
	const std::vector<Thunk*>& TotalOrder() const
	{
		return thunk_total_order_;
	}
	...
	{
		return depended_by_.count(thunk);
	}
...
private:
	...
	void AddDependenciesOnTransitiveOperands(const Thunk& thunk,
