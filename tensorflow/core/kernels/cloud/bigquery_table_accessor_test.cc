...
protected:
	...
	Status CreateTableAccessor(const string& project_id,
	...
	{
		return BigQueryTableAccessor::New(project_id, dataset_id, table_id,
				timestamp_millis, row_buffer_size, "", columns, partition,
				std::unique_ptr<AuthProvider>(new FakeAuthProvider),
				std::unique_ptr<HttpRequest::Factory>(
						new FakeHttpRequestFactory(&requests_)), &accessor_);
	}
